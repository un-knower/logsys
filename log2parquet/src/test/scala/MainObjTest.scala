...
//      "--f","MsgBatchManagerV3.xml,settings.properties","--c","inputPath=/data_warehouse/ods_origin.db/log_origin/a.json","--c","masterURL=local[1]","--c","startDate=20170904", "--c" ,"startHour=22" ,"--c" ,"taskFlag=111")
