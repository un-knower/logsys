...
//    "--f","MsgBatchManagerV3.xml,settings.properties","--c","inputPath=/data_warehouse/ods_origin.db/log_origin/fileType.json","--c","masterURL=local[1]","--c","startDate=20171117", "--c" ,"startHour=09" ,"--c" ,"taskFlag=111","--c" ,"realLogType=all","--c" ,"appId=all")
    "--f","MsgBatchManagerV3.xml,settings.properties","--c","inputPath=/data_warehouse/ods_origin.db/log_origin/arrayList.json","--c","masterURL=local[1]","--c","startDate=20171117", "--c" ,"startHour=09" ,"--c" ,"taskFlag=111","--c" ,"realLogType=all","--c" ,"appId=all")
    MainObj.main(args)
  }
