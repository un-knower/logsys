...
//      "--f","MsgBatchManagerV3.xml,settings.properties","--c","inputPath=/data_warehouse/ods_origin.db/log_origin/b.json","--c","masterURL=local[1]","--c","startDate=20171110", "--c" ,"startHour=09" ,"--c" ,"taskFlag=111")
    "--f","MsgBatchManagerV3.xml,settings.properties","--c","inputPath=/data_warehouse/ods_origin.db/log_origin/fileType.json","--c","masterURL=local[1]","--c","startDate=20171117", "--c" ,"startHour=09" ,"--c" ,"taskFlag=111","--c" ,"realLogType=helios_play_trailerinterfacecall")
    //    "--f","MsgBatchManagerV3.xml,settings.properties","--c","inputPath=/data_warehouse/ods_origin.db/log_origin/key_day=20171031/key_hour=20/part-00842","--c","masterURL=local[1]","--c","startDate=20171031", "--c" ,"startHour=20" ,"--c" ,"taskFlag=111")
...
@Test
  ...
  @Test
  def test5(): Unit ={
    val path = "ods_view.db/log_medusa_main20_playview/key_day=20170904/key_hour=22"
    val productCode = path.split("/")(1).split("_")(1)
    println(s"productCode is $productCode")
  }
