...
//      "--f","MsgBatchManagerV3.xml,settings.properties","--c","inputPath=/data_warehouse/ods_origin.db/log_origin/b.json","--c","masterURL=local[1]","--c","startDate=20171110", "--c" ,"startHour=09" ,"--c" ,"taskFlag=111")
    "--f","MsgBatchManagerV3.xml,settings.properties","--c","inputPath=/data_warehouse/ods_origin.db/log_origin/test.json","--c","masterURL=local[1]","--c","startDate=20171110", "--c" ,"startHour=09" ,"--c" ,"taskFlag=111")
