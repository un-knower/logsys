...
/**
  ...
  * 特定字段类型修改，如nameList 为 arrayString
  * 1.读入parquet路基
  ...
  *  sh tmp3.sh log_medusa_main3x_medusa_launcher_change  %201712% sidList
  */
object Start3 {
...
//        val tablePattern = "log_medusa_main3x_medusa_launcher_change"
